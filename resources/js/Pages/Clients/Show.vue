    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between">
                ...
                <div class="flex">
                    <Link :href="'/clients/email/' +client.id" class="flex p-2 rounded border border-gray-300 shadow mr-2">Send Email</Link>
                    <a :href="'/clients/pdf/'+client.id" class="flex p-2 rounded border border-gray-300 shadow" target="_blank">
